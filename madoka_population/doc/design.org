...
This version still doesn’t work with literal maps that have symbols for keys unless you quote the input map. But, not too shabby, I think. (I might put it on Code Review to see what someone else thinks.)
